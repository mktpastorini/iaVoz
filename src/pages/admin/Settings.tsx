...
const settingsSchema = z.object({
  ...
  voice_model: z.enum(["browser", "openai-tts", "gemini-tts", "deepgram-tts"]),
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div><Label>Provedor de Voz (TTS)</Label><Controller control={control} name="voice_model" render={({ field }) => (<Select onValueChange={field.onChange} value={field.value}><SelectTrigger><SelectValue /></SelectTrigger><SelectContent><SelectItem value="browser">Navegador (Padrão)</SelectItem><SelectItem value="openai-tts">OpenAI TTS</SelectItem><SelectItem value="deepgram-tts">Deepgram TTS</SelectItem></SelectContent></Select>)} /></div>
